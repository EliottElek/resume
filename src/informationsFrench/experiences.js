const experiences = [
  {
    ...
    body: [
      {
        point:
          "Intervenant full stack (MERN) pour la junior entreprise de l'ECE.",
      },
      {
        point:
          "Développement de sites e-commerce, notamment en ReactJS et NodeJS.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      {
        point: "Conception de sites statiques avec Gatsby et React",
      },
      {
        point: "Réalisations de sites vitrines sur la plateforme Worpress",
      },
      {
        point:
          "Prototypage, conception et réalisation de sites e-commerce avec Woocommerce",
      },
      {
        point: "Contact et suivi régulier avec les clients",
      },
    ],
  },
  {
    ...
    body: [
      {
        point:
          "Stage dans le secteur Recherche et Développement chez PSA Poissy",
      },
      {
        point:
          "Création d’un programme Excel en VBA permettant de faciliter la récupération et l’interprétation de certaines données liées aux retours utilisateurs",
      },
    ],
  },
  {
    ...
    body: [
      {
        point:
          "Manutentionnaire : installation, réparation et récupération de bornes de rechargement de portables sur plusieurs sites et pays : Roland Garros, Parc des Princes, Belgique, Pays-Bas, Normandie, etc.",
      },
      {
        point:
          "Hôte : assistance des personnes qui souhaitaient mettre leurs portables à recharger, maintenance des machines pendant tout le tournoi",
      },
    ],
  },
];
